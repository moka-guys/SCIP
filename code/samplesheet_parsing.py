...
def row_to_vars(row_index, dataframe):
    ...
    #true_gt = patient_row.loc["true_gt"]
    HBB_filename = patient_row.loc["HBB_mpileup"]
    SCED_filename = patient_row.loc["SCED_mpileup"]

    # return variables
    #return [sample, mat_gt, pat_gt, true_gt, HBB_filename, SCED_filename]
    return [sample,HBB_filename,SCED_filename]
